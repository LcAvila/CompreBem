		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<div class="container-fluid">
				...
				<button class="p-2 m-4 me-5 ms-5 bg-light" id="auth">
					<a href="login.jsp"><i class="fa-regular fa-user"></a></i> <a
						href="login.jsp">Entrar</a>
				</button>
				<div class="keep-products">
					<i class="fa-regular fa-heart p-2 m-1"></i> <i
						class="fa-solid fa-bag-shopping p-2 m-1"></i>
				</div>
			</div>
		</nav>
	</header>
...
<script src="login.js" type="script/login.js"></script>
